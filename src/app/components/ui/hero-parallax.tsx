...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[350vh] md:h-[300vh] py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] "
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  const words = ["captura", "institucional", "ecommerce", "Landing page"];
